...
# Mutation statoistics V2: inc subvar
...
```{,dpi=300, fig.height = 6, fig.width = 20}
D_E_F_GRID=cowplot::plot_grid(NUM_MUT_PLT,Freq_MUT_PLT, NUM_MUT_PUM_PEPS_PLT,NUM_PROT_PLT,nrow=1,rel_widths = c(0.75,0.75,1.0,1.5), align="h")
D_E_F_GRID
```
